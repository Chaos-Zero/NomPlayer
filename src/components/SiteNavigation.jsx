...
// Exported so other views (e.g. HeroLeaderboard's GameFAQs support badge, see
// HomePage.jsx) can reuse the same "playlists" glyph rather than introducing
// a second icon for the same concept - className is opt-in, the nav's own
// bare <item.Icon /> usage below relies on ancestor CSS for sizing.
export function CommunityPlaylistsIcon({ className }) {
  return (
    <svg
      viewBox="0 0 20 20"
      aria-hidden="true"
...
const NAV_ITEMS = [
  ...
  {
    id: 'communityPlaylists',
    label: 'Community Playlists',
    Icon: CommunityPlaylistsIcon,
  },
  {
    id: 'database',
