...
export function ReloadIcon({ className = 'collection-icon' }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function TrashIcon({ className = 'collection-icon' }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function SaveIcon({ className = 'collection-icon' }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
