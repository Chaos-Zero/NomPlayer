...
export default function DeletePlaylistConfirmDialog({
  isOpen = false,
  isSubmitting = false,
  playlistName = '',
  onClose,
  ...
  return (
    <div className="modal-backdrop" role="presentation" onClick={onClose}>
      <div
        className="modal-card delete-playlist-dialog"
        role="dialog"
        aria-modal="true"
        aria-labelledby="delete-pl-dialog-title"
      ...
      >
        <div className="modal-header">
          <div className="delete-dialog-header-content">
            ...
            <h2 id="delete-pl-dialog-title">Delete Playlist?</h2>
          </div>
          <button
            className="btn-close"
            type="button"
