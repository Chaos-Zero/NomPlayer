-- Fix column name in get_user_hydrated_state.
-- The previous version joined track_sources directly and referenced
-- ts.source_external_id, but that alias only exists in the track_catalog view.
-- The actual column in track_sources is external_id.
