...
-- ── profiles ──────────────────────────────────────────────────────────────────
-- select_public (USING true, all roles) already covers everything;
-- select_own and select_authenticated are redundant.
...
-- ── tournaments ───────────────────────────────────────────────────────────────
-- Replace FOR ALL with separate write policies to remove conflicting SELECT.
...
-- ── track_user_feedback ───────────────────────────────────────────────────────
-- select_public (USING true) supersedes select_all_authenticated (also USING true).
...
-- auth.uid() lives inside a subquery here; wrap it the same way.
